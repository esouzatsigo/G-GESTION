                                        ...
                                        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                                            {missingClientRow && (
                                                <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center' }}>
                                                    <span style={{ fontSize: '0.65rem', color: '#fbbf24' }}>¿Cliente nuevo?</span>
                                                    <button
                                            ...
                                            {missingFranchiseRow && (
                                                <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center' }}>
                                                    <span style={{ fontSize: '0.65rem', color: '#fbbf24' }}>¿Falta Franquicia?</span>
                                                    <button
                                                        onClick={() => {
                                                        ...
                                                        style={{ fontSize: '0.6rem', padding: '2px 6px', background: '#fbbf24', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold' }}
                                                    >
                                                        + FRANQUICIA
                                                    </button>
                                                </div>
                                            ...
                                            {missingSucursalRow && type === 'equipos' && (
                                                <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center' }}>
                                                    <span style={{ fontSize: '0.65rem', color: '#fbbf24' }}>¿Falta Sucursal?</span>
                                                    <button
                                                        onClick={() => {
